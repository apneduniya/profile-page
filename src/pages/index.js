      ...
      <main className={styles.main}>
        <div className={styles.container}>
          ...
          <div className={styles.childContainer}>
            ...
            <Link href="/api/download" download="profile.pdf"><lottie-player src="https://assets10.lottiefiles.com/temp/lf20_CALcmp.json" background="transparent" speed="1" style={{ margin: "20px 0", padding: 0, width: 200, height: 50, cursor: "pointer" }} loop autoplay></lottie-player></Link>
          </div>
        </div>
      </main>
    </>
