      ...
      <main className={styles.main}>
        <div className={styles.container}>
          ...
          <div className={styles.childContainer}>
            ...
            <a href="https://profile-page-sigma.vercel.app/api/download"><lottie-player src="https://assets10.lottiefiles.com/temp/lf20_CALcmp.json" background="transparent" speed="1" style={{ margin: "20px 0", padding: 0, width: 200, height: 50, cursor: "pointer" }} loop autoplay></lottie-player></a>
          </div>
        </div>
      </main>
    </>
